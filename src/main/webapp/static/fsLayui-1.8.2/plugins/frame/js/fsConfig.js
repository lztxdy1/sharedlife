...
layui.define([], function (exports) {
	...
	fsConfig["global"] = {
		...
		"loginUrl" : "/admin/user/login", //登录url
		"uploadUrl" : "/upload", //上传附件url
		"uploadHtmlUrl" : "/static/fsLayui-1.8.2/plugins/frame/views/upload.html", //上传附件html地址，默认/plugins/frame/views/upload.html
		"loadDataType":"0",//加载数据类型，1：使用缓存数据，0：实时查询，默认0  （编辑或查看是否取缓存数据）
		...
		"page" : { //分页配置
			...
			"response": {//响应配置
				"countName": "total", //数据总数的字段名称，默认：results.data.total
