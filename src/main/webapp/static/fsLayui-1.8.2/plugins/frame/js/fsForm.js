...
//			  	  images_upload_url: '/upload',
    ...
    $(thisForm.config.elem).find("textarea.mytext").each(function(){
    	var _this = $(this);
...
*/    		CKEDITOR.replace(id
		,{extraPlugins: 'codesnippet',codeSnippet_theme: 'zenburn','height' : 800}
		);
    	}
    });
	};
  ...
  */
   ...
   */
	...
	if(param["content"]|| param["content"]==""){
		param["content"] = CKEDITOR.instances.content.getData();
	}
